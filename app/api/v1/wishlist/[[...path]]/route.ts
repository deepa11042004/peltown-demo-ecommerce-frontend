...
const proxyWishlistRequest = async (request: NextRequest, context: RouteContext) => {
  ...
  try {
    ...
    return NextResponse.json(
      {
        message: "Unable to reach wishlist service",
...
export async function GET(request: NextRequest, context: RouteContext) {
  return proxyWishlistRequest(request, context);
}
